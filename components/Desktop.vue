...
const { apps, currentApps, backgroundUrl, isMenuVisible, hour, date, isSelecting, selectionBoxStyles, maximize, startSelection, updateSelection, endSelection, handleOutsideClick,
